...
describe('Testing server...', () => {
	...
	*/
	test("TU0-45 Constructor with user and password", async(done) => {
	...
	/**
	* TU0-46 Testing del costruttore senza user & password
	*/
	test("TU0-46 Constructor", async(done) => {
	...
	*/
	test("TU0-47 Bad Constructor", async(done) => {
		expect(() => {
	...
	*/
	test("TU0-48 getDatasources method", async(done) => {
	...
	*/
	test("TU0-49 getDatasourcesFields method", async(done) => {
	...
	*/
	test("TU0-50 getLastValue method", async(done) => {
	...
	*/
	test("TU0-51 getLastValueAsync method", async(done) => {
	...
	*/
	test("TU0-52 getListData method", async(done) => {
	...
	*/
	test("TU0-53 Constructor connection for write_db", async(done) => {
	...
	*/
	test("TU0-54 Write probabilities on influx", async(done) => {
		let conWrite = new InfluxDB(ip, port, db_write, db_write); 
	...
	*/
	test("TU0-55 Try throw exception in constructor params", () => {
		expect(() => {
