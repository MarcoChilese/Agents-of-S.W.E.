...
describe('#graph', () => {
  ...
  it('verifies parent nodes added', () => {
    const g = jsbayes.newGraph();
    const n1 = g.addNode('n1', ['t', 'f']);
    const n2 = g.addNode('n2', ['t', 'f']);
    const n3 = g.addNode('n3', ['t', 'f']);
  ...
  it('verifies binary cpt initialization', () => {
    const g = jsbayes.newGraph();
    const n1 = g.addNode('n1', ['t', 'f']);
    const n2 = g.addNode('n2', ['t', 'f']);
    const n3 = g.addNode('n3', ['t', 'f']);
  ...
  it('verifies non-binary cpt initialization', () => {
    const g = jsbayes.newGraph();
    const n1 = g.addNode('n1', ['a', 'b', 'c']);
    const n2 = g.addNode('n2', ['a', 'b']);
    const n3 = g.addNode('n3', ['a', 'b', 'c']);
  ...
  it('verfies sampling', () => {
    ...
    const r = g.sample(10000)
      .then((r) => {
        expect(r).to.equals(10000);

        expect(n1.sampledLw.length).to.equal(2);
        let s1 = n1.sampledLw[0];
        let s2 = n1.sampledLw[1];
        let v1 = s1 / (s1 + s2);
        let v2 = s2 / (s1 + s2);
  ...
  it('verifies sampling with observation', () => {
    const g = jsbayes.newGraph();
    const n1 = g.addNode('n1', ['t', 'f']);
    const n2 = g.addNode('n2', ['t', 'f']);
    const n3 = g.addNode('n3', ['t', 'f']);
  ...
  it('verifies sampling with observation alternative method', () => {
    const g = jsbayes.newGraph();
    const n1 = g.addNode('n1', ['t', 'f']);
    const n2 = g.addNode('n2', ['t', 'f']);
    const n3 = g.addNode('n3', ['t', 'f']);
  ...
  it('verifies samples are saved when requested', () => {
    const g = jsbayes.newGraph();
    const n1 = g.addNode('n1', ['t', 'f']);
    const n2 = g.addNode('n2', ['t', 'f']);
    const n3 = g.addNode('n3', ['t', 'f']);
  ...
  it('verifies samples are converted to csv', () => {
    const g = jsbayes.newGraph();
    g.saveSamples = true;
    const n1 = g.addNode('n1', ['t', 'f']);
    const n2 = g.addNode('n2', ['t', 'f']);
...
describe('#nodes', () => {
  ...
  it('verifies get index of values', () => {
    const g = jsbayes.newGraph();
    const n1 = g.addNode('n1', ['t', 'f']);
    const n2 = g.addNode('n2', ['t', 'f']);
    const n3 = g.addNode('n3', ['f', 't']); // swapped

    let i1 = n1.valueIndex('t');
    let i2 = n1.valueIndex('f');
  ...
  it('verifies set cpt one parent', () => {
    const g = jsbayes.newGraph();
    const n1 = g.addNode('n1', ['0', '1']);
    const n2 = g.addNode('n2', ['0', '1']);
    const n3 = g.addNode('n3', ['0', '1', '2']);
  ...
  it('verifies set cpt two parents', () => {
    const g = jsbayes.newGraph();
    const n1 = g.addNode('n1', ['0', '1']);
    const n2 = g.addNode('n2', ['0', '1']);
    const n3 = g.addNode('n3', ['0', '1']);
  ...
  it('verifies set cpt three parents', () => {
    const g = jsbayes.newGraph();
    const n1 = g.addNode('n1', ['0', '1']);
    const n2 = g.addNode('n2', ['0', '1']);
    const n3 = g.addNode('n3', ['0', '1']);
    const n4 = g.addNode('n4', ['0', '1']);
