...
\hline
\rowcolor{grigio}3.0.3 & 2019-04-24 & Progettista & Luca Violato & Rimozione delle Panoramiche dei Casi d'uso, in quanto la loro stesura non era volta a modellare casi d'uso, ma solo a fornire un contesto generale dell'applicazione\\
\hline
3.0.2 & 2019-04-24 & Progettista & Luca Violato & Modellazione di UC4.1 come caso d'uso a se stante, separato da UC4. Conseguente stesura di §\ref{UC36} con aggiornamento del tracciamento §\ref{Tracciamento} e §\ref{TracciamentoRF}\\
\hline
\rowcolor{grigio}3.0.1 & 2019-04-23 & Progettista & Luca Violato & Modellazione di §\ref{UC2.4.3} attraverso ereditarietà con conseguente stesura di §\ref{UC2.4.5}, §\ref{UC2.4.6}, §\ref{UC2.4.7} e §\ref{UC2.4.8} a seguito delle segnalazioni indicate per la RQ\\
\hline
