...
\begin{document}
	...
	%		\end{itemize}
		...
		Il preventivo di costo finale è pari a \textbf{13634.00}€, come descritto all'interno del documento \textit{Piano di Progetto v4.0.0}, alla sezione § 6.2.\\ %controllare se invariata
		\-\\
