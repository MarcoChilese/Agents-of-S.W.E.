...
\hline
\rowcolor{grigio} 3.1.0 & 2019-05-15 & Verificatore & Bogdan Stanciu & Verifica documento \\ 
\hline
3.0.13 & 2019-05-14 & Verificatore & Carlotta Segna & Inserimento grafici relativi alle metriche in §\ref{RA_metriche} \\
\hline
\rowcolor{grigio}3.0.12 & 2019-05-13 & Amministratore & Marco Favaro & Stesura test di integrazione per la componente "Server" in §\ref{test_i}\\
\hline
...
\hline
3.0.7 & 2019-05-02 & Programmatore & Diego Mazzalovo &  Aggiornamento test di validazione §\ref{test_v}\\
\hline
\rowcolor{grigio}3.0.6 & 2019-05-01 & Amministratore & Luca Violato & Stesura ulteriori test di unità per la componente "GetApiGrafana" in §\ref{test_u}\\
\hline
...
\hline
\rowcolor{grigio}3.0.4 & 2019-04-29 & Amministratore & Luca Violato & Stesura ulteriori test di unità per la componente "TresholdCtrl" in §\ref{test_u}\\
\hline
3.0.3 & 2019-04-28 & Amministratore & Luca Violato & Stesura ulteriori test di unità per la componente "TemporalPolicyCtrl" in §\ref{test_u}\\
\hline
\rowcolor{grigio} 3.0.2 & 2019-04-26 & Amministratore & Carlotta Segna & Inserimento metrica MTPC08 \\
\hline
3.0.1 & 2019-04-24 & Responsabile & Luca Violato & Stesura ulteriori test di unità per la componente "Parser" in §\ref{test_u}\\
\hline
