...
\hline
\rowcolor{grigio}TU0-126 & Viene verificato che il metodo \texttt{deletenetwork(net)} di \textit{ConnectServer} elimini dal server la rete "net" e torni \textbf{True} nel caso di buona riuscita dell'operazione & S.\\
\hline
