...
\hline
\rowcolor{grigio}TU0-95 & Viene verificato che il metodo \texttt{setConfirmationToTrue} di \textit{TemporalPolicyCtrl} segnali con un messaggio di errore se viene impostata una politica temporale avente valore associato al campo \textbf{secondi} > 60 & S.\\
\hline
...
\hline
\rowcolor{grigio}TU0-97 & Viene verificato che il metodo \texttt{setConfirmationToTrue} di \textit{TemporalPolicyCtrl} segnali con un messaggio di errore se viene impostata una politica temporale avente valore associato al campo \textbf{minuti} > 60 & S.\\
\hline
...
\hline
\rowcolor{grigio}TU0-99 & Viene verificato che il metodo \texttt{setConfirmationToTrue} di \textit{TemporalPolicyCtrl} segnali con un messaggio di errore se viene impostata una politica temporale avente valore negativo associato al campo \textbf{ore} & S.\\
\hline
