...
\hline
MTPDD19 & Indice di Gulpease & 100 & $\geq 40$ \\
\hline
\rowcolor{grigio}MTPDD20 & Correttezza Ortografica & 0 errori & 0 errori \\ 
\hline
...
\label{func}
Le seguenti metriche e ciò che lo standard intende con \textit{Funzionalità} è descritto all'interno del documento \textit{Norme di Progetto v4.0.0} nella sezione §F.2.2.\\
...
Gli obiettivi metrici stabiliti per le metriche descritte nei paragrafi §F.2.2 delle \textit{Norme di Progetto v4.0.0} sono : 

\begin{longtable}{|C{.15\textwidth}|C{.24\textwidth}|C{.24\textwidth}|C{.24\textwidth}|}
\hline
\rowcolor{bluelogo}\textbf{\textcolor{white}{ID}} & \textbf{\textcolor{white}{Nome}} & \textbf{\textcolor{white}{Ottimalità}} & \textbf{\textcolor{white}{Accettabilità}}\\
\hline
MTPDS21 & Soddisfacimento Requisiti Obbligatori & 100\% & 100\%\\
\hline
\rowcolor{grigio}MTPDS22 & Soddisfacimento Requisiti Opzionali Accettati & 100\% & 60\% \\
\hline
MTPDS23 & Percentuale requisiti totali coperti & 100\% & 75\% \\ 
\hline
...
Le seguenti metriche e ciò che lo standard intende con \textit{Affidabilità} è descritto all'interno del documento \textit{Norme di Progetto v4.0.0} nella sezione §F.2.3. \\
\textbf{Obiettivi di Qualità} :
...
\rowcolor{bluelogo}\textbf{\textcolor{white}{ID}} & \textbf{\textcolor{white}{Nome}} & \textbf{\textcolor{white}{Ottimalità}} & \textbf{\textcolor{white}{Accettabilità}}\\
\hline
MTPDS24 & Densità di Failure & 100\% & 100\%\\
\hline
\rowcolor{grigio}MTPDS25 & Tolleranza agli Errori & 100\% & 60\% \\ 
\hline
\caption{Funzionalità}
\label{Funzionalità}
\end{longtable}
...
Le seguenti metriche e ciò che lo standard intende con \textit{Efficienza} è descritto all'interno del documento \textit{Norme di Progetto v4.0.0} nella sezione §F.2.4. \\
...
\rowcolor{bluelogo}\textbf{\textcolor{white}{ID}} & \textbf{\textcolor{white}{Nome}} & \textbf{\textcolor{white}{Ottimalità}} & \textbf{\textcolor{white}{Accettabilità}}\\
\hline
MTPDS26 & Tempo di Risposta Medio & $\leq 1s$ & 1s<x $\leq 5s$\\
\hline
\rowcolor{grigio}MTPDS27 & Tempo di Risposta di Picco  & $\leq 4s$ & 4s<x $\leq 7s$ \\ 
\hline
\caption{Efficienza}
\label{Efficienza}
\end{longtable}
...
Le seguenti metriche e ciò che lo standard intende con \textit{Usabilità} è descritto all'interno del documento \textit{Norme di Progetto v4.0.0} nella sezione §F.2.5. \\
...
Gli obiettivi metrici stabiliti per le metriche descritte nel paragrafo §F.2.5 delle \textit{Norme di Progetto v4.0.0} sono : 

\begin{longtable}{|C{.15\textwidth}|C{.24\textwidth}|C{.24\textwidth}|C{.24\textwidth}|}
\hline
\rowcolor{bluelogo}\textbf{\textcolor{white}{ID}} & \textbf{\textcolor{white}{Nome}} & \textbf{\textcolor{white}{Ottimalità}} & \textbf{\textcolor{white}{Accettabilità}}\\
\hline
MTPDS28 & Tempo medio di Comprensione & $\leq 5m$ & 5m<x $\leq 10m$\\
\hline
\rowcolor{grigio}MTPDS29 & Tempo medio di Apprendimento & $\leq 10m$ & 10m<x $\leq 20m$ \\ 
\hline
\caption{Usabilità}
\label{Usabilità}
\end{longtable}
...
Le seguenti metriche e ciò che lo standard intende con \textit{Manutenibilità} è descritto all'interno del documento \textit{Norme di Progetto v4.0.0} nella sezione §F.2.6. \\
...
\rowcolor{bluelogo}\textbf{\textcolor{white}{ID}} & \textbf{\textcolor{white}{Nome}} & \textbf{\textcolor{white}{Ottimalità}} & \textbf{\textcolor{white}{Accettabilità}}\\
\hline
MTPDS30 & Percentuale Commenti/Codice & 20\%<x $\leq 30\%$ & $\leq 20\%$\\
\hline
...
Ciò che lo standard intende con \textit{Portabilità} è descritto all'interno del documento \textit{Norme di Progetto v4.0.0} nella sezione §F.2.7. \\
