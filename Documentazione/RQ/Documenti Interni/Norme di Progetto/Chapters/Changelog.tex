...
\endhead
\rowcolor{grigio}2.0.1 & 2019-03-18 & Progettista & Marco Chilese & Spostamento §\ref{ProcessiPrimari_Sviluppo_StudioFattibilità} da §\ref{Sviluppo} a §\ref{Fornitura}. Spostamento §\ref{Server} da §\ref{ProcessiPrimari} a §\ref{ProcessiOrganizzativi_Strumenti}\\
\hline
