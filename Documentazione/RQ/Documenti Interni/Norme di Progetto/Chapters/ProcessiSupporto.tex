...
I verificatori devono controllare che i diagrammi UML prodotti rispettino lo standard UML 2.x e che siano corretti semanticamente.

\subsubsection{Strumenti}
\begin{itemize}
	\item \textbf{Software}: per la verifica del codice JavaScript è stato scelto Jest;
	\item \textbf{Documenti}: 
	\item \textbf{Gestione processi e feedback}: è stato scelto di utilizzare il sistema integrato di issues presente su GitLab.
\end{itemize}
