...
\hline
\rowcolor{grigio}ROF2.5.9.4 & Il Sistema deve verificare che gli insiemi di valori associati ai diversi stati stati attraverso le soglie siano tra loro coerenti, negando la conferma del collegamento in caso contrario & Obbligatorio & UC2\\
\hline
...
\hline
\rowcolor{grigio}ROF4.4.8 & L'Utente deve visualizzare un messaggio di notifica di avvio del monitoraggio della rete bayesiana attualemnte visualizzata nel pannello & Obbligatorio & UC34\\
\hline
...
\hline
\rowcolor{grigio}RDF10.4 & L'Utente deve visualizzare un messaggio di avvenuta rimozione della rete bayesiana nel caso in cui l'operazione sia andata a buon fine & Obbligatorio & UC29\\
\hline
