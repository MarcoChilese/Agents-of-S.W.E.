...
\hline
ROF2.5.3.1 & Il Sistema deve fornire un elenco delle tabelle del database selezionato come sorgente di dati & Obbligatorio & UC2 UC18\\
\hline
ROF2.5.3.2 & L'utente deve poter selezionare la tabella del database desiderata & Obbligatorio & UC2\\
\hline
ROF2.5.3.3 & Il Sistema deve aggiornare i flussi dati disponibili per la selezione a seconda della tabelle selezionata dall'utente & Obbligatorio & UC2\\
\hline
...
\hline
\rowcolor{grigio}ROF7.2 & Il sistema deve poter visualizzare un messaggio di errore nel caso in cui il collegamento al server non sia giunto a buon fine& Obbligatorio & UC23\\
\hline
ROF7.3 & Il sistema deve poter visualizzare un messaggio di avvenuto collegamento al server nel caso in cui sia giunto a buon fine& Obbligatorio & UC27\\
\hline
...
\hline
UC2 & \makecell{ROF2\\ROF2.1.2\\ROF2.5\\ROF2.5.3\\ROF2.5.3.1\\ROF2.5.3.2\\ROF2.5.3.3\\ROF2.5.4\\ROF2.5.5\\ROF2.5.9\\ROF2.5.9.1\\ROF2.5.9.2\\ROF2.5.9.3\\ROF2.5.9.4\\ROF2.5.10\\ ROF2.5.11\\ROF2.6\\ROF2.6.2}\\
\hline
