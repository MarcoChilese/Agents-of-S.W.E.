...
\begin{itemize}
	...
	\item \textbf{Inclusioni:} (\hyperref[UC26]{UC26 (§\ref*{UC26})}) Visualizzazione notifica di avvenuto collegamento;
\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{Inclusioni:} \hyperref[UC29]{UC29 (§\ref*{UC29})}: l'utente visualizza una notifica di avvenuta rimozione della rete bayesiana;
\end{itemize}
