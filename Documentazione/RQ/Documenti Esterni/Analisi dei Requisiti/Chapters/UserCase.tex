...
\begin{itemize}
	...
	\end{enumerate}
	\item \textbf{Postcondizione:} L'utente sta visualizzando le impostazioni di collegamento.
	\item \textbf{Scenario Principale:} L'utente per accedere alla visualizzazione delle impostazioni di collegamento clicca il pulsante con etichetta "Visualizzazione impostazione collegamento".
\end{itemize}
