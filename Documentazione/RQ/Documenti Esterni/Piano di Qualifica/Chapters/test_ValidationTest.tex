\begin{longtable}{|C{.15\textwidth}|C{.13\textwidth}|m{.65\textwidth}|C{.08\textwidth}|}
\hline
...
TV0-9.1.1 & ROF9.1.1 &
	...
	\begin{enumerate}
		...
		\item L'utente clicca sul pulsante sopra citato;
		\item Il Sistema modifica l'interfaccia utente, nascondendo la sezione delle impostazioni delle reti e visualizzando quella relativa ai monitoraggi attivN.I.
	\end{enumerate}
	& N.I. \\
\hline	
...
\rowcolor{grigio}TV0-9.2 & ROF9.2 &
	...
	\begin{enumerate}
		...
		\item L'utente clicca sul pulsante sopra citato;
		\item Il Sistema modifica l'interfaccia utente cambiando da quella dei monitoraggi attivi a quella delle impostazioni delle retN.I.
	\end{enumerate}
	& N.I. \\
\hline
...
\rowcolor{grigio}TV2-10.3 & RDF10.3 &
	...
	\begin{enumerate}
		...
		\item Il Server elimina la rete dalla memoria con le relative impostazionN.I.
	\end{enumerate}
	& N.I. \\
\hline
