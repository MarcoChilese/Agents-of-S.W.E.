...
\hline
\rowcolor{grigio} TS-06 & ROF1.4.1 & Verificare che il sistema si accerti che il file caricato dall'utente sia solo con estensione \texttt{.json} & S. \\
\hline
TS0-07 & ROF1.4.2 & Verificare l'autenticità del file da parte del sistema & S. \\
\hline 
\rowcolor{grigio} TS0-08 & ROF1.5 & Verificare che il sistema, una volta caricato il file, inizializzi la rete bayesiana & S. \\
\hline 
TS1-08 & ROF1.6 & Verifica che il sistema memorizzi la rete bayesiana precedentemente caricata & S. \\
\hline
\rowcolor{grigio} TS0-09 & ROF1.7 & Verifica che il sistema visualizzi un messaggio di avvenuto caricamento della reta bayesiana & S. \\
\hline
...
\hline
\rowcolor{grigio} TS0-11 & ROF2.1 & Verifica che il sistema interpreti la rete bayesyana caricata da file & S. \\
\hline
TS0-12 & ROF2.1.1 & Verificare che il Sistema mostri a interfaccia utente il nominativo per ogni nodo della rete.& S.\\
\hline
\rowcolor{grigio} TS0-13 & ROF2.1.2& Verificare che il Sistema mostri, per ogni nodo della rete bayesiana, la corrispondente checkbox per identificare se un nodo è collegato ad un flusso dati o meno. & S. \\
\hline
...
\hline
\rowcolor{grigio}TS0-15 & ROF2.5.3 & Verificare che il Sistema mostri un elenco di flussi dati coerente con la sorgente dati selezionata dall'utente. & S. \\
\hline
...
\hline
\rowcolor{grigio}TS0-21 & ROF2.5.3.6 & Verificare che il sistema aggiorni i flussi dati disponibili in base alla selezione della tabella del database. & S. \\ 
\hline
...
\hline
\rowcolor{grigio}TS0-23 & ROF2.5.5 & Verificare che il Sistema mostri la lista dei possibili stati del nodo selezionato. & S. \\ 
\hline
...
\hline
\rowcolor{grigio}TS0-25 & ROF2.5.6.1 & Verificare che il Sistema metta a disposizione un campo dati numerico che permetta la definizione della soglia. & S. \\ 
\hline
...
\hline
\rowcolor{grigio}TS1-27 & RDF2.5.6.3  & Verificare che il Sistema metta a disposizione un campo dati che permetta di definire se una soglia è critica o meno.  & S. \\
\hline
...
\hline
\rowcolor{grigio}TS1-29 & RDF2.5.6.5  & Verificare che il Sistema consenta l'aggiunta di molteplici soglie relative allo stesso stato di un nodo. & S. \\
\hline
...
\hline
\rowcolor{grigio}TS0-31 & ROF2.5.8 & Verificare che il Sistema metta a disposizione un bottone per la conferma delle soglie definite dall'utente. & S. \\
\hline
