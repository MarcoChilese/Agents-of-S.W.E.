...
\hline
\rowcolor{grigio} TU0-31 & Viene verificato il lancio di un'eccezione nel caso in cui il metodo \texttt{saveNetworkToFile(net)} fallisca & Superato \\
\hline
...
\hline
\rowcolor{grigio} TU0-32 & Viene verificato che la richiesta \texttt{uploadnetwork} ritorni un messaggio di successo nel caso in cui il metodo non ritorni errori & Superato \\
\hline
...
\hline 
\rowcolor{grigio} TU0-52 & Viene verificato che la richiesta \texttt{getnetworkprob/:net} al server richiami il metodo \texttt{parserNetworknameURL(name)} &  S. \\ 
\hline 
...
\hline 
\rowcolor{grigio} TU0-72 & Viene verificato che le probabilità calcolate nella rete bayesiana vengano salvate all'interno del database  & S. \\ 
\hline 
