...
\hline
\rowcolor{grigio}RFF2.8.4 & Il Sistema deve eliminare eventuali alert associati ai nodi della rete bayesiana nel caso in cui l'utente interagisca con il Sistema per modificare il collegamento dei nodi & Obbligatorio & UC2 UC4 UC7 UC13\\
\hline
