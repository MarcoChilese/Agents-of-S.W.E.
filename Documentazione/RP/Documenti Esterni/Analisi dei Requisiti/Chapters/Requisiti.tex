...
\hline
\rowcolor{grigio}ROV6 & L'interfaccia grafica del plug-in è sviluppata utilizzando \textit{HTML5}\glossario e \textit{CSS3}\glossario & \textit{Grafana}: guida per gli sviluppatori \\
\hline
