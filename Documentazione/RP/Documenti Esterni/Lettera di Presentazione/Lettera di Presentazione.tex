...
\begin{document}
	...
	\begin{letter}{
		...
		Il preventivo di costo finale è fissato pari a \textbf{14043.00}€, come descritto all'interno del documento Piano di Progetto \textit{v2.0.0}, alla sezione § 5.8.2.\\ %controllare se invariata
		\-\\
