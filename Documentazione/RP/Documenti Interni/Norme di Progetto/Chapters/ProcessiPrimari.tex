...
Il team \texttt{Agents Of S.W.E.} ha deciso, per avere un ambiente comune su cui testare il prodotto in via di sviluppo, di dotarsi di un server noleggiato online attraverso la nota piattaforma di hosting \textit{DigitalOcean}\footnote{\url{https://www.digitalocean.com/}}.\\
