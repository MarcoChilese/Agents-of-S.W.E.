...
\begin{itemize}
	\item \textbf{MTPC14 Media commit per settimana} ~\\
	...
	\item \textbf{MTPC15 Percentuali build superate} ~\\
	Calcolo della media delle build effettuate sulla repository contente il codice per lo sviluppo del prodotto. Il calcolo avviene tramite un bot connesso al sistema di versionamento GitLab. 
\end{itemize}
...
\begin{itemize}
	\item \textbf{MTPDD16 Indice di Gulpease}\-\\
Il gruppo ha deciso di utilizzare l'\textit{indice di Gulpease}\glossario\footnote{\url{https://it.wikipedia.org/wiki/Indice\_Gulpease}} per misurare la leggibilità di un testo. È stato sviluppato appositamente uno script in \textit{Python} per automatizzare la procedura e allo stesso modo velocizzarla. La procedura verrà utilizzata a documento terminato e completo così da valutare il lavoro svolto dai redattori.
	...
	\item \textbf{MTPDD17 Correttezza Ortografica}\-\\
...
\begin{itemize}
	...
	\item \textbf{MTPDS18 Soddisfacimento Requisiti Obbligatori}\-\\
...
dove PRO è la percentuale di requisiti obbligatori soddisfatti, ROS i requisiti obbligatori soddisfatti e ROT i requisiti obbligatori totali.
	...
	\item \textbf{MTPDS19 Soddisfacimento Requisiti Opzionali Accettati}\-\\
...
\begin{itemize}
	\item \textbf{MTPDS20 Densità di Failure} \-\\
	...
	\item \textbf{MTPDS21 Tolleranza agli Errori} \-\\
...
\begin{itemize}
	...
	\item\textbf{MTPDS18 Tempo Medio di Comprensione}\-\\
