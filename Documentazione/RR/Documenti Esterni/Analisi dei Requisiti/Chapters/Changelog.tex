...
\hline
1.0.4 & 2019-02-02 & Amministratore & Luca Violato & Stesura §\ref{UC14}. Completa rivisitazione §\ref{UC5} e conseguente stesura di §\ref{UC11}, §\ref{UC12} e §\ref{UC13}\\
\hline
\rowcolor{grigio}1.0.3 & 2019-02-01 & Responsabile & Bogdan Stanciu &  Stesura §\ref{UC4} (ex UC3.2) conseguente ridenominazione UC seguenti. Sistemazione di tutti i diagrammi UML \\
\hline
1.0.2 & 2019-01-29 & Amministratore & Luca Violato & Leggera modifica §\ref{UC9}. Aumento livello di dettaglio §\ref{UC2.2}, stesura §\ref{UC2.1}, §\ref{UC15}. Analisi di maggior dettaglio della fonte UC2 per §\ref{RF}, aggiunti svariati requisiti\\
\hline
