...
\begin{itemize}
	...
	\item \textbf{Scenario principale}: l'utente clicca il pulsante con etichetta "+" nel pannello "G\&B Panel" nella dashboard.
\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{Scenario principale}:
	\begin{enumerate}
		\item \hyperref[UC5.1]{UC5.1 (§\ref*{UC5.1})} L'utente clicca sul pulsante "Collega Alert";
	...
	\end{enumerate}
	\item \textbf{Estensioni:} \hyperref[UC13]{UC13 (§\ref*{UC13})}: l'utente visualizza un messaggio di errore nel caso in cui abbia modificato il collegamento dei nodi.
	
\end{itemize}

\subsubsection{UC5.1 - Click pulsante "Collega Alert"}\label{UC5.1}
\begin{itemize}
	\item \textbf{Attore primario}: Utente;
	\item \textbf{Precondizione}: l'utente deve aver aggiunto il pannello "G\&B Panel";
	\item \textbf{Postcondizione}: l'utente viene condotto alle impostazioni di edit del pannello 
	"G\&B Panel", sotto la voce Alert;
	\item \textbf{Scenario principale}: l'utente clicca il bottone "Collega Alert".
\end{itemize}

\subsubsection{UC5.2 - Definizione parametri alert}\label{UC5.2}
\begin{itemize}
	\item \textbf{Attore primario}: Utente;
	\item \textbf{Attore secondario}: \textit{Grafana};
	\item \textbf{Precondizione}: l'utente ha cliccato il pulsante "Collega Alert" \hyperref[UC5.1]{UC5.1 (§\ref*{UC5.1})};
	\item \textbf{Postcondizione}: l'utente ha definito i parametri dell'alert di un nodo non collegato al flusso di dati.
	\item \textbf{Scenario principale}: 
	\begin{enumerate}
		\item L'utente, nelle impostazioni di \textit{Grafana}, definisce i parametri dell'alert desiderato del nodo non collegato al flusso di dati;
		\item L'utente conferma la creazione dell'alert.
	\end{enumerate}
\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{Precondizione:} 
	\begin{enumerate}
		\item L'utente ha definito almeno un alert \hyperref[UC5]{UC5 (§\ref*{UC5})};
		\item L'utente visualizza gli alert \hyperref[UC7]{UC7 (§\ref*{UC7})}.
	\end{enumerate}
	\item \textbf{Postcondizione}: l'utente ha rimosso l'alert associato al nodo non collegato al flusso dati;
	\item \textbf{Scenario principale}: 
	\begin{enumerate}
		\item L'utente nella lista di alert, seleziona l'alert da eliminare;
		\item \hyperref[UC6.1]{UC6.1 (§\ref*{UC6.1})} L'utente clicca sul pulsante "Elimina Alert";
		\item \hyperref[UC6.2]{UC6.2 (§\ref*{UC6.2})} L'utente attraverso le impostazioni di \textit{Grafana} elimina l'alert.
	\end{enumerate}
\end{itemize}

\subsubsection{UC6.1 - Click pulsante "Elimina Alert"}\label{UC6.1}
\begin{itemize}
	\item \textbf{Attore primario}: Utente;
	\item \textbf{Precondizione}: l'utente ha selezionato l'alert da rimuovere.
	\item \textbf{Postcondizione}: l'utente viene condotto alle impostazioni di edit del pannello "G\&B Panel", sotto la voce Alert;
	\item \textbf{Scenario principale}: l'utente clicca il bottone "Elimina Alert".
\end{itemize}

\subsubsection{UC6.2 - \textit{Grafana} elimina l'alert}\label{UC6.2}
\begin{itemize}
	\item \textbf{Attore primario}: Utente;
	\item \textbf{Attore secondario}: \textit{Grafana};
	\item \textbf{Precondizione}:  l'utente ha cliccato sul pulsante "Elimina Alert" \hyperref[UC6.1]{UC6.1 (§\ref*{UC6.1})}.
...
\begin{itemize}
	\item \textbf{Attore primario}: Utente;
	\item \textbf{Attore secondario}: \textit{Grafana};
	\item \textbf{Precondizioni}: l'utente ha definito correttamente un alert (\hyperref[UC5]{UC5(§\ref*{UC5})});
	\item \textbf{Postcondizioni}: l'utente visualizza l'elenco degli alert definiti e il loro stato;
	\item \textbf{Scenario principale}:
	\begin{enumerate}
		\item L'utente attraverso le impostazioni messe a disposizione di \textit{Grafana}, aggiunge il pannello di visualizzazione degli alert.
		\item Viene mostrato l'elenco degli alert;
		\item L'utente visualizza lo stato degli alert definiti sui nodi non collegati al flusso di dati.
	\end{enumerate}
\end{itemize}
