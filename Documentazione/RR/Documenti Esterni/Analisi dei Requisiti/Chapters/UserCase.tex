...
\begin{itemize}
	...
	\item \textbf{Scenario principale}:
	\begin{enumerate}
		\item \hyperref[UC5.1]{UC5.1 (§\ref*{UC5.1})} L'utente clicca sul pulsante "Add panel" per aggiungere il pannello degli alert;
...
\subsubsection{UC5.1 - Aggiungere pannello degli alert}\label{UC5.1}
\begin{itemize}
	\item \textbf{Attore primario}: Utente;
	\item \textbf{Precondizione}: l'utente deve aver aggiunto il pannello "G\&B Panel";
	\item \textbf{Postcondizione}:
	\begin{enumerate}
		\item L'utente ha aggiunto il pannello degli alert;
		\item L'utente viene condotto alle impostazioni di edit del pannello per definire l'alert.
	\end{enumerate}
	\item \textbf{Scenario principale}: 
	\begin{enumerate}
		\item L'utente clicca il bottone "Add Panel" sulla dashboard di \textit{Grafana};
		\item L'utente seleziona il pannello relativo agli alert denominato "Alert List".
	\end{enumerate}
\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{Precondizione}: l'utente ha aggiunto il pannello degli alert \hyperref[UC5.1]{UC5.1 (§\ref*{UC5.1})};
	\item \textbf{Postcondizione}: l'utente ha definito i parametri dell'alert di un nodo non collegato al flusso di dati;
	\item \textbf{Scenario principale}: l'utente, nelle impostazioni di \textit{Grafana}, definisce i parametri dell'alert desiderato del nodo non collegato al flusso di dati;
\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{Scenario principale}: 
	\begin{enumerate}
		\item \hyperref[UC6.1]{UC6.1 (§\ref*{UC6.1})} L'utente clicca sul pulsante "Delete Alert";
		\item \hyperref[UC6.2]{UC6.2 (§\ref*{UC6.2})} L'utente attraverso le impostazioni di \textit{Grafana} elimina l'alert.
	\end{enumerate}
\end{itemize}

\subsubsection{UC6.1 - Click pulsante "Delete Alert"}\label{UC6.1}
\begin{itemize}
	\item \textbf{Attore primario}: Utente;
	\item \textbf{Precondizione}: l'utente ha selezionato l'alert da rimuovere;
	\item \textbf{Postcondizione}: l'utente viene condotto alle impostazioni di edit del pannello degli alert;
	\item \textbf{Scenario principale}: l'utente clicca il bottone "Delete Alert";
\end{itemize}
...
\begin{itemize}
	\item \textbf{Attore primario}: Utente;
	\item \textbf{Attore secondario}: \textit{Grafana};
	\item \textbf{Precondizione}:  l'utente ha cliccato sul pulsante "Delete Alert" \hyperref[UC6.1]{UC6.1 (§\ref*{UC6.1})};
...
\subsubsection{UC7.2 - Rimozione di alert attraverso \textit{Grafana}}\label{UC7.2}
\begin{itemize}
	\item \textbf{Attore primario}: Utente;
	\item \textbf{Attore secondario}: \textit{Grafana};
