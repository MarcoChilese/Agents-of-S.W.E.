...
\hline
RDF4.3.1 & Il Sistema, indipendentemente dalla politica temporale stabilita dall'utente, deve ricalcolare le probabilità al verificarsi del superamento della soglia di un nodo collegato al flusso di monitoraggio & Desiderabile & UC4 VER-2019-02-08\\
\hline
\rowcolor{grigio}RFF5 & Il Sistema deve mettere a disposizione di \textit{Grafana} i dati per l'operazione di creazione di alert ad essi associati da parte dell'utente & Opzionale & UC5\\
\hline
RFF5.1 & Il Sistema deve mettere a disposizione dell'utente un pulsante "Aggiungi Alert" per la defizione dell'alert & Opzionale & UC5 \\
\rowcolor{grigio}RFF6 & Il Sistema deve mostrare all'utente gli alert associati al flusso di dati collegato alla rete bayesiana & Opzionale & UC7\\ 
\hline
RFF6.1 & L'utente deve poter rimuovere gli alert associati ai nodi della rete bayesiana & Opzionale & UC6\\ 
\hline
...
\hline
UC5 & \makecell{RFF5 \\ RF5.1}\\
\hline
\rowcolor{grigio}UC6 & \makecell{RFF6.1}\\
\hline
UC7 & \makecell{ROF2.5.3\\RFF6}\\
\hline
