...
\hline
\rowcolor{grigio}RF2.2 & Il Sistema mettere a disposizione dell'utente una lista di flussi dati a cui collegare i nodi desiderati & Obbligatorio & UC2\\
\hline
...
\hline
\rowcolor{grigio}RF4 & L'utente deve poter aggiungere alert ai nodi caricati o a quelli derivati & Obbligatorio & UC5\\ 
\hline
