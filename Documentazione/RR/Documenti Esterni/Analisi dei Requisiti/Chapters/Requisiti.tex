...
\hline
\rowcolor{grigio}ROQ4 & Il prodotto deve essere sviluppato nei tempi stabiliti all'interno del \textit{Piano di Progetto v1.0.0} & Obbligatorio & Decisione Interna\\
\hline
...
\hline
\rowcolor{grigio}Decisione Interna & \makecell{ROQ1.1\\RDQ1.2\\ROQ2.1\\RDQ2.2\\ROQ3\\ROQ4}\\
\hline
Piattaforma \textit{Grafana} & \makecell{ROV1}\\
\hline
\rowcolor{grigio}UC1 & \makecell{ROF1\\ROF1.1\\ROF1.2\\ROF1.3\\ROF1.4\\RFF1.4.1\\RFF1.4.2}\\
\hline
UC2 & \makecell{ROF2\\ROF2.1\\ROF2.2\\ROF2.3\\ROF2.4}\\
\hline
