	...
	\begin{itemize}
		...
		\item \textbf{Materiale didattico del corso di Ingegneria del Software:}
			\begin{itemize}
				...
				\item \textbf{Verifica e Validazione: Introduzione}: \\ \url{https://www.math.unipd.it/~tullio/IS-1/2017/Dispense/L17.pdf};
				
				\item \textbf{Verifica e Validazione: Analisi Statica}: \\ \url{https://www.math.unipd.it/~tullio/IS-1/2017/Dispense/L18.pdf};
				\item \textbf{Verifica e Validazione: Analisi Dinamica}: \\ \url{https://www.math.unipd.it/~tullio/IS-1/2017/Dispense/L19.pdf};
			\end{itemize}
