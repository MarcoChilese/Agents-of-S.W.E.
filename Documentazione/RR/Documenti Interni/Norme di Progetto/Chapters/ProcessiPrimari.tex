...
Un caso d'uso consiste nel valutare ogni requisito con lo scopo di definire gli attori che interagiscono con il sistema. Il \texttt{gruppo}, nel documento, oltre a fornire una spiegazione verbosa e dettagliata dei casi d'uso, fornirà una rappresentazione grafica utilizzando il linguaggio UML.
