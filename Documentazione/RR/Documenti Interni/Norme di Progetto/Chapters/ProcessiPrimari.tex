...
\begin{itemize}
	...
	\item \textbf{Riunioni interne:} riunioni del \texttt{gruppo} dove l'obiettivo è discutere i casi d'uso del capitolato, e studiare il dominio di utilizzo;
...
Un caso d'uso consiste nel valutare ogni requisito con lo scopo di definire gli attori che interagiscono con il sistema. Il \texttt{gruppo}, nel documento, oltre a fornire una spiegazione verbosa e dettagliata dei casi d'uso, fornirà una rappresentazione grafica nel linguaggio UML.
Ogni caso d'uso avrà le seguenti informazioni:
\begin{itemize}
	\item TO DO PROSSIMA RIUNIONE
\end{itemize}
