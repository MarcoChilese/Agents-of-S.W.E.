\subsection{Capitolato C2}\label{C2}
...
\begin{itemize}
	\item \textbf{Firebase\footnote{\hyperref[Link al sito]{https://firebase.google.com/}}\glossario}: database realtime in cloud fornito da Google;
	\item \textbf{Hunpos\footnote{\hyperref[Link al sito]{https://github.com/mivoq/hunpos}}\glossario, FreeLing\footnote{\hyperref[Link al sito]{http://nlp.lsi.upc.edu/freeling/}}\glossario o simili}: software opensource che implementano part-of-speech tagger\glossario;
